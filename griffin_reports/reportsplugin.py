...
try:
    from griffin.api.plugins import GriffinPluginWidget
except ImportError:
    from griffin.plugins import GriffinPluginWidget  # Griffin 3 compatibility
...
class ReportsPlugin(GriffinPluginWidget):
    """Reports plugin."""
    ...
    def __init__(self, parent=None):
        ...
        """
        GriffinPluginWidget.__init__(self, parent)
        self.main = parent  # Griffin 3 compatibility
    ...
    def check_compatibility(self):
        ...
        valid = True
        if PYQT4 or PYSIDE:
            messages.append('Griffin-reports does not work with Qt4')
            valid = False
